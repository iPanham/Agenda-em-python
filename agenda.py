...
agenda = { 
    "Pessoa 1":{
        ...
        "email":["pessoa@email.com", "emailprofissional@gmail.com"],
        "endereço":["Rua 123"]
    },
    "Pessoa 2":{
        "telefone":["11 9874-5678"],
        "email":["pessoa@email.com", "pessoa2profissional@gmail.com"],
        "endereço":["Rua 456"]
    }    
}
...
#print(contato_para_texto("Pessoa 2", **agenda["Pessoa"]))
...
def agenda_para_texto(**agenda_completa):
    ...
    e retorna uma string com este dicionário formatado"""
    formato_texto = ""
    for nome_contato, formas_contato in agenda_completa.items():
        ...
        formato_texto = f"{formato_texto}------------------------\n"
    return formato_texto
#poderiamos testar esse assim:
#print(agenda_para_texto(**agenda))

#função para mudar nome de contato
def altera_nome_contato(agenda_original:dict, nome_original:str, nome_atualizado:str):
    """Recebe a agenda original em forma de dicionário, o nome_original
    e o nome_atualizado em forma de string. Busca o nome original
    no dicionário e fizer a exclusão do contato antigo e inclusão do novo"""
...
#para testar:
#altera_forma_contato(agenda["Pessoa 1"]["telefone"], "11 1234-5678", "11 4321-8765")
#print(agenda_para_texto(**agenda))

def exclui_contato(agenda:dict, nome_contato:str):
    """Recebe uma agenda completa com o dicionário e o nome do contato
    como string.
...
#podemos testar se funcionou assim:    
...
def inclui_contato(agenda:dict, nome_contato:str, **formas_contato):
    """Recebe uma agenda completa como dicionário, o nome do novo
    contato como string e as formas de contato.
...
#inclui_contato(agenda, "pessoa teste", telefone=["11 54565-6563"], email=["pessoateste@gmail.com"])
#print(agenda_para_texto(**agenda))

def inclui_forma_contato(forma_contato:dict, forma_incluida:str, valor_incluido:str):
    """Recebe um dicionário com as formas de contato, a forma de contato
    que será incluida ou alterada e o valor que será incluido.
    Caso a forma de contato já possua valores, o novo valor será
    adicionado na lista e retonará True.
    Caso a forma de contato ainda não exista e não estiver presente
    na tupla de formas de contatos suportados, será incluída e o novo valor
    será incluido em uma lista, retornando True.
    Caso a forma de contato ainda não exista e não estiver presente
    na tupla de formas de contatos suportados, retornará False"""
...
#teste atual:
#inclui_forma_contato(agenda["Pessoa teste"], "endereço", "Rua dos testes")
#print(agenda_para_texto(**agenda))

def usuario_inclui_contato(agenda:dict):
    nome = input("informe o nome do novo contato que será incluido na agenda: ")
    dicionario_formas = {}
    ...
    if len(dicionario_formas.keys()) > 0:
        ...
        print("É ncessário incluir pelo menos uma forma de contato\nA agenda não foi alterada.")
...
def usuario_exclui_contato(agenda:dict):
    nome = input("Informe o nome de usuário que deseja excluir: ")
...
def usuario_altera_nome_contato(agenda:dict):
    ...
    nome_original = input("Informe o nome de contato que deseja alterar: ")
...
def usuario_altera_forma_contato(agenda:dict):
    ...
    if nome in agenda.keys():
        print(f"As formas de contatos suportados pelo sistema são {contatos_suportados}")
        forma_incluida = input("Qual a forma de contato que deseja incluir? ")
        if forma_incluida in contatos_suportados:
